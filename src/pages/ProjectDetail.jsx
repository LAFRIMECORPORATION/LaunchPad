...
export default function ProjectDetail() {
    ...
    // ÉTAPE CLÉ : Si l'ID n'est pas dans l'URL, on le pioche dans les options passées au contexte
    ...
    if (loading) {
        return (
            <div style={{ textAlign: "center", padding: "100px 20px" }}>
                ...
                <p style={{ color: "var(--text-muted)" }}>Chargement de la fiche projet...</p>
            </div>
        );
    }
    ...
    if (!project) {
        return (
            <div className="animate-fadeUp" style={{ padding: 32, color: "var(--text-muted)", textAlign: "center" }}>
                ...
                <p>
                    Identifiant cible détecté :{" "}
                    <code style={{ background: "var(--bg-light)", padding: "2px 6px" }}>
                        {id || "Aucun ID reçu"}
                    </code>
                </p>
            ...
            <div className="two-col" style={{ gap: 32 }}>
                ...
                <div className="two-col-main">
                    ...
                    <p className="project-detail-lead" style={{ marginTop: 0, color: "var(--text-secondary)", fontSize: 17, lineHeight: 1.6, marginBottom: 24 }}>
                        {project.tagline || (project.description ? project.description.substring(0, 150) + "..." : "Description en cours de rédaction...")}
                    </p>
                        ...
                        <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <div style={{ fontSize: 12, color: "var(--text-muted)" }}>
                                        {project.author?.profile?.university || "Étudiant"} • Porteur de projet
                                    </div>
                                </div>
                            </div>
                                ...
                                similarProjects.map(sp => (
                                    <div key={sp.id} className="similar-mini">
                                        ...
                                        <p style={{ fontSize: 12, color: "var(--text-secondary)", margin: "8px 0" }}>
                                            {sp.tagline || (sp.description ? sp.description.substring(0, 80) + "..." : "")}
                                        </p>
                                        <button
                                            className="btn btn-secondary btn-sm btn-full"
                                            onClick={() => navigate && navigate("project-detail", { id: sp.id })}
                                        >
                                            Voir le projet
                                        </button>
                                    </div>
                ...
                <div className="two-col-side-lg">
                    <div className="funding-card">
                        ...
                        <div style={{ marginTop: 14, padding: 12, background: "var(--bg-light)", borderRadius: "var(--r-md)", fontSize: 11, color: "var(--text-muted)", textAlign: "center", lineHeight: "1.4" }}>
                            🔒 <strong>Régulation COSUMAF & Escrow Bancaire</strong> · Les fonds restent séquestrés en toute sécurité jusqu'au succès du palier de l'objectif.
                        </div>
                    </div>
