    ...
    <div className="animate-fadeUp">
      ...
      <div className="page-header">
        <div className="page-header-left">
          <h1 className="page-title">
            Bonjour, {currentUser?.firstName || "Étudiant"} 👋
          </h1>
          <p className="page-subtitle">
            Voici l'activité de votre espace aujourd'hui.
          </p>
        </div>
        <div className="page-header-actions dashboard-student-header-actions">
          <button
            className="btn btn-primary dashboard-student-new-project-btn"
      ...
      <div className="grid-4" style={{ marginBottom: 24, marginTop: 20 }}>
        ...
        <StatCard
          ...
          color="#22C55E"
          bgColor="#F0FDF4"
          delta="+23 cette semaine"
        />
        <StatCard
          icon="💰"
          value="8"
          label="Intérêts investisseurs"
          color="#F59E0B"
          bgColor="#FFFBEB"
        />
        <StatCard
        ...
        {[
          {
            ...
            label: "Feed",
            id: "feed",
            desc: "Actualités de l'écosystème",
          },
          {
            icon: "🏆",
            label: "Badges",
            id: "badges",
            desc: "Votre score de réputation",
          },
          {
            icon: "📅",
            label: "Rendez-vous",
            id: "appointments",
            desc: "Gérez vos meetings",
          },
          {
            icon: "📚",
            label: "Academy",
            id: "academy",
            desc: "Formez-vous gratuitement",
          },
          {
            icon: "💬",
            label: "Forum",
      ...
      <div className="ai-banner" style={{ marginBottom: 24 }}>
        ...
        <div className="ai-banner-text">
          ...
          <div className="ai-banner-sub">
            Notre IA a identifié des opportunités de mutualisation ou de
            collaboration avec des projets proches du vôtre.
          </div>
        </div>
        <button
        ...
        >
          ...
          <div className="card" style={{ padding: 20 }}>
            ...
            {loading ? (
              ...
              >
                Vous n'avez pas encore publié de projet. Utilisez l'accès rapide
                ou le bouton en haut pour commencer.
              </p>
            ) : (
              myProjects.map((p) => {
                  ...
                  <div key={p.id} style={{ marginBottom: 16 }}>
                    ...
                    >
                      <SocialActions
                        ...
                        size="sm"
                        onCommentClick={() =>
                          navigate("project-detail", { project: p })
                        }
                      />
                    </div>
                  </div>
        ...
        <div className="two-col-side">
          ...
          <div className="card" style={{ padding: 20, marginBottom: 20 }}>
            ...
            <div
              style={{
                background:
                  "linear-gradient(135deg, rgba(91,115,245,.05), rgba(139,92,246,.05))",
            ...
            >
              ...
              <div style={{ fontSize: 12, color: "var(--text-secondary)" }}>
                3 nouvelles offres de thèse/financement correspondent à votre
                secteur.
              </div>
            </div>
            <button
